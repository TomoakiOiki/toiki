  ...
  return (
    <Menu>
      ...
      <MenuList>
        ...
        <MenuItem>
          <Link as={Link} href="https://twitter.com/kn_prg" _hover={{ textDecoration: "none" }} isExternal>
            Twitter
          </Link>
        </MenuItem>
        <MenuItem>
          <Link as={Link} href="https://github.com/TomoakiOiki" _hover={{ textDecoration: "none" }} isExternal>
            Github
          </Link>
        </MenuItem>
      </MenuList>
